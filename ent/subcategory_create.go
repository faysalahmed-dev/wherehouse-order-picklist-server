...
func (scc *SubCategoryCreate) SetDescriptions(s string) *SubCategoryCreate {
	scc.mutation.SetDescriptions(s)
	return scc
}

// SetValue sets the "value" field.
func (scc *SubCategoryCreate) SetValue(s string) *SubCategoryCreate {
...
func (scc *SubCategoryCreate) SetNillableCategoryID(id *uuid.UUID) *SubCategoryCreate {
	if id != nil {
...
func (scc *SubCategoryCreate) SetUserID(id uuid.UUID) *SubCategoryCreate {
	scc.mutation.SetUserID(id)
	return scc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (scc *SubCategoryCreate) SetNillableUserID(id *uuid.UUID) *SubCategoryCreate {
	if id != nil {
...
func (scc *SubCategoryCreate) SetUser(u *User) *SubCategoryCreate {
...
func (scc *SubCategoryCreate) check() error {
	...
	if _, ok := scc.mutation.Descriptions(); !ok {
		return &ValidationError{Name: "descriptions", err: errors.New(`ent: missing required field "SubCategory.descriptions"`)}
	}
	if v, ok := scc.mutation.Descriptions(); ok {
	...
	if _, ok := scc.mutation.Value(); !ok {
		return &ValidationError{Name: "value", err: errors.New(`ent: missing required field "SubCategory.value"`)}
	}
	if v, ok := scc.mutation.Value(); ok {
...
func (scc *SubCategoryCreate) createSpec() (*SubCategory, *sqlgraph.CreateSpec) {
	...
	if value, ok := scc.mutation.Descriptions(); ok {
	...
	if nodes := scc.mutation.CategoryIDs(); len(nodes) > 0 {
		...
		_node.category_sub_categories = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := scc.mutation.UserIDs(); len(nodes) > 0 {
		...
		_node.user_sub_categories = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
