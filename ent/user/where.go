...
func HasProductItems() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProductItemsWith(preds ...predicate.ProductItem) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasSubCategories() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSubCategoriesWith(preds ...predicate.SubCategory) predicate.User {
	return predicate.User(func(s *sql.Selector) {
