...
func (uc *UserCreate) AddCategoryIDs(ids ...uuid.UUID) *UserCreate {
...
func (uc *UserCreate) AddSubCategoryIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddSubCategoryIDs(ids...)
	return uc
}

// AddSubCategories adds the "sub_categories" edges to the SubCategory entity.
func (uc *UserCreate) AddSubCategories(s ...*SubCategory) *UserCreate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uc.AddSubCategoryIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.SubCategoriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
